	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office:Hotelaide Ck court.<br>
				old nairobi Road,opp64resort Eldoret.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0725211992">0725211992</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@hotelaide.com" class="email__addr">support@hotelaide.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Award winner</span><br>Clean health
			</div>
			...
			<div class="banner-social">
				...
				<a href="https://www.instagram.com/premal_bv/" class="banner-social__link">
